...
// team.thykingdom.net is the network's verified Resend sending domain and is
// what the other Thy Kingdom projects send from. Replies still go to the
// festival inbox via RESEND_REPLY_TO.
const FROM =
  process.env.RESEND_FROM ||
  "Jesus Festival Movement <hello@team.thykingdom.net>";
