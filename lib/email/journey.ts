    ...
    build: (name) => ({
      ...
      list: [
        ...
        },
        {
          ...
          body: `Our 13-step guide for any leader anywhere who wants to start a festival in their own city — checklists, timelines and hard-won warnings, given away free. <a href="${SITE_URL}/start-a-festival" style="color:#f5c451;">Read it here</a>`,
        },
      ],
      extra: `
        <p style="margin:16px 0 0;font-size:16px;line-height:1.7;color:#e8ebf7;">
  ...
  // ── Day 21 ─────────────────────────────────────────────────────────
  {
    ...
    build: (name) => ({
      ...
      list: [
        ...
        {
          title: "3. Host",
          body: `Start one in your city. The full playbook is free and we'll walk with you personally. <a href="${SITE_URL}/start-a-festival" style="color:#f5c451;">Open the playbook</a>`,
        },
        {
          title: "4. Give",
