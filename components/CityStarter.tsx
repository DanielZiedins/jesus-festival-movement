...
export default function CityStarter() {
  ...
  function resetProgress() {
    ...
    try {
      ...
      // There is no additional action needed when storage is unavailable.
    }
  }
